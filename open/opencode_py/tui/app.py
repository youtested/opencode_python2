...
class OpenCodeTUI(App):
    ...
    def _start_turn(self, sid: str, value: str, engine: AgentLoop) -> None:
    ...
    def action_interrupt_escape(self) -> None:
        ...
        the session's interrupt flag that the active engine checks at each
        stream chunk / tool boundary, ending the turn as interrupted
